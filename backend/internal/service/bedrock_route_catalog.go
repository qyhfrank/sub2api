...
var bedrockRouteCatalog = map[string][]BedrockRoute{
	...
	"anthropic.claude-sonnet-4-20250514-v1:0": {
		{Key: BedrockRouteKey{CanonicalModel: "anthropic.claude-sonnet-4-20250514-v1:0", Scope: "apac", RuntimeRegion: "ap-northeast-1"}, InvocationModel: "apac.anthropic.claude-sonnet-4-20250514-v1:0"},
