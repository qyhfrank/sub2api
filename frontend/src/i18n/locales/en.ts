export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      bedrockRouteMode: 'Route Mode',
      bedrockRouteModeHint: 'Choose between legacy direct invoke and routed all-routes behavior',
      bedrockRouteModeOff: 'Off',
      bedrockRouteModeAllRoutes: 'All Routes',
      bedrockRouteScope: 'Route Scope',
      bedrockRouteScopeHint: 'Optional. Narrow routed selection to a policy surface such as on-demand, US, EU, or APAC',
      bedrockRoutePreferredRegion: 'Preferred Region',
      bedrockRoutePreferredRegionHint: 'Optional. All Routes uses this only as an initial preference, not a hard lock',
      bedrockRouteAllEligible: 'All eligible routes',
