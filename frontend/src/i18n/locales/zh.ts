export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      bedrockRouteMode: '路由模式',
      bedrockRouteModeHint: '在传统直连模式和 All Routes 路由模式之间切换',
      bedrockRouteModeOff: '关闭',
      bedrockRouteModeAllRoutes: 'All Routes',
      bedrockRouteScope: '路由范围',
      bedrockRouteScopeHint: '可选。将路由限制在 on-demand、US、EU、APAC 等策略范围内',
      bedrockRoutePreferredRegion: '偏好区域',
      bedrockRoutePreferredRegionHint: '可选。All Routes 仅将其作为初始偏好，而不是硬性锁定',
      bedrockRouteAllEligible: '所有可用路由',
